...
This tool was developed as a class project, addressing challenges encountered during attempts to re-implement and extend the original R version, leading to a focus on building a consistently performing Python-native solution.
