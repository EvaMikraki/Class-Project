# In scpred_py_simple/_preprocessing.py
import scanpy as sc
...
def standard_preprocess(adata):
    """
    Applies a standard, complete preprocessing workflow to raw AnnData.
    Includes: filtering, normalization, log-transform, HVG selection, and scaling.
    """
    print("Applying standard scPred-Py preprocessing workflow...")
    ...
    # Subset to only HVGs before scaling
