...
class ScPredModel:
    ...
    def __init__(self):
        ...
        self.ref_adata_processed_ = None # Stores the preprocessed reference adata (HVG-selected)
    ...
    def train(self, ref_adata, cell_type_key, n_components=30, 
              ...
              svm_kernel='linear', svm_c=1.0, svm_random_state=42, svm_class_weight=None, # Added svm_class_weight
        ...
        self.classifier_ = _training.train_svm(
            X_pca, labels, 
            kernel=svm_kernel, c=svm_c, random_state=svm_random_state, class_weight=svm_class_weight # Pass class_weight
        )
